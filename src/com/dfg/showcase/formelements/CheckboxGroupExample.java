...
public class CheckboxGroupExample extends FormModel {
	...
	public CheckboxGroupExample() {
		...
		add(new SectionModel("String selection").add(
				new TextModel("A checkbox group allows multiple selections."))
				.add(new CheckboxGroupModel<String>(
						"Where do you spend your spare time?", Arrays.asList(
								"at the beach", "on the soccer field",
								"on the couch", "in front of my computer"))));
		...
		add(new SectionModel("Enum selection")
				...
				.add(new CheckboxGroupModel<LeisureActivity>(
						"Where do you spend your spare time?", Arrays
		...
		add(new SectionModel("Enum selection with selected value")
				...
				.add(new CheckboxGroupModel<LeisureActivity>(
						"Where do you spend your spare time?", Arrays
								.asList(LeisureActivity.values()),
						new LeisureActivityLabeller(), Arrays
								.asList(LeisureActivity.COMPUTER,
										LeisureActivity.BEACH))));

	}

	private class LeisureActivityLabeller implements
			ChoiceLabeller<LeisureActivity> {
