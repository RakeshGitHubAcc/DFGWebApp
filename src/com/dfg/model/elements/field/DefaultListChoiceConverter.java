...
public class DefaultListChoiceConverter implements IConverter<Object> {
	...
	public Object convertToObject(String value, Locale locale) {
		try {
			...
			throw new RuntimeException(
					String.format(
							"Invalid value for single select choice: %s. "
									+ "A number representing the index of the selected choice was expected!",
							value));
		}
	}
	...
	public String convertToString(Object value, Locale locale) {
		throw new NotImplementedException(
				"The method convertToString is not supported by this converter!");
	}
}
